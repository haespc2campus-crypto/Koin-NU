...
export const tables = ["profiles", "ranting_profile", "pengurus", "petugas", "donatur", "pengambilan_koin", "verifikasi_setoran", "setoran_petugas", "setoran_lazisnu", "penyaluran_dana", "dokumentasi_kegiatan", "berita", "settings"];
